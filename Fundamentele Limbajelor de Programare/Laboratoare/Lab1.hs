...
char c = sat (c ==) -- verifica daca argumentul este c
...
>>> parseFirst efactor "-(3)"
WAS Right (EminuU (ENum 3.0))
NOW Prelude.undefined

>>> parseFirst efactor "-(-(3))"
WAS Right (EminuU (EminuU (ENum 3.0)))
NOW Prelude.undefined
-}
efactor :: Parser Expr
efactor = negativeFactor <|> parensExpr <|> enum
  where
    ...
    parensExpr = symbol "(" *> eexpr <* symbol ")"
...
WAS WAS WAS Right (EPlu (ENum 1.0) (ENum 2.0),"")
WAS WAS NOW Right (EPlu (ENum 1.0) (ENum 2.0))
...
WAS WAS WAS Right (EPlu (EDiv (ENum 10.0) (ENum 2.0)) (EMul (ENum 3.0) (EPlu (ENum 5.0) (EMul (ENum 2.0) (ENum 3.0)))),"a")
WAS WAS NOW Right (EPlu (EDiv (ENum 10.0) (ENum 2.0)) (EMul (ENum 3.0) (EPlu (ENum 5.0) (EMul (ENum 2.0) (ENum 3.0)))))
WAS NOW Right (EPlu (EDiv (ENum 10.0) (ENum 2.0)) (EMul (ENum 3.0) (EPlu (ENum 5.0) (EMul (ENum 2.0) (ENum 3.0)))))
